#!/usr/bin/env python3
# Adapted from https://github.com/emmi-lili/emmi-lili (scripts/cards.py).
"""
...
THEMES = {
    "dark": {
        "bg": "#0d1117", "border": "#30363d", "title": "#70A5FD",
        "text": "#C0CAF5", "muted": "#8b949e", "value": "#e6edf3",
        "accent": "#BB9AF7",
    },
    "light": {
        "bg": "#ffffff", "border": "#d0d7de", "title": "#2952a3",
